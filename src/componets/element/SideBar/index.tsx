    ...
    <>
      <nav
        ...
        style={
          hiddenSideBar
            ? { width: "260px" }
            : { minWidth: 0, width: "0", padding: "20px" }
        }
      >
        <div
                ...
                <div className={"text-xs text-white py-[6px] leading-5 w-full"}>
                  <Disclosure>
                    {({ open }) => (
                      <>
                        <Disclosure.Button
                          className={`flex justify-between items-center w-full py-2 text-left hover:bg-[#1B2B65] ${
                            routeActive.includes("/manage-account")
                              ? "bg-[#1b2b65]"
                              : ""
                          }`}
                        >
                        ...
                        <Link to={"/manage-account/account"}>
                          <Disclosure.Panel
                            className={`py-4 pl-[64px] hover:bg-[#1B2B65] ${
                              routeActive.includes("/manage-account/account")
                                ? "bg-[#1b2b65]"
                                : ""
                            }`}
                          >
                  ...
                  <Disclosure>
                    {({ open }) => (
                      <>
                        <Disclosure.Button
                          className={`flex justify-between items-center w-full py-2 text-left hover:bg-[#1B2B65] ${
                            routeActive.includes("/manage-question")
                              ? "bg-[#1b2b65]"
                              : ""
                          }`}
                        >
                        ...
                        <Link to={"/manage-question/question"}>
                          <Disclosure.Panel
                            className={`py-4 pl-[64px] hover:bg-[#1B2B65] ${
                              routeActive == "/manage-question/question"
                                ? "bg-[#1b2b65]"
                                : ""
                            }`}
                          >
                        ...
                        <>
                          <Link to={"/manage-question/grade"}>
                            <Disclosure.Panel
                              className={`py-4 pl-[64px] hover:bg-[#1B2B65] ${
                                routeActive == "/manage-question/grade"
                                  ? "bg-[#1b2b65]"
                                  : ""
                              }`}
                            >
                          ...
                          <Link to={"/manage-question/subject"}>
                            <Disclosure.Panel
                              className={`py-4 pl-[64px] hover:bg-[#1B2B65] ${
                                routeActive == "/manage-question/subject"
                                  ? "bg-[#1b2b65]"
                                  : ""
                              }`}
                            >
                          ...
                          <Link to={"/manage-question/class"}>
                            <Disclosure.Panel
                              className={`py-4 pl-[64px] hover:bg-[#1B2B65] ${
                                routeActive == "/manage-question/class"
                                  ? "bg-[#1b2b65]"
                                  : ""
                              }`}
                            >
                          ...
                          <Link to={"/manage-question/tag"}>
                            <Disclosure.Panel
                              className={`py-4 pl-[64px] hover:bg-[#1B2B65] ${
                                routeActive == "/manage-question/tag"
                                  ? "bg-[#1b2b65]"
                                  : ""
                              }`}
                            >
                          ...
                          <Link to={"/manage-question/knowledge-unit"}>
                            <Disclosure.Panel
                              className={`py-4 pl-[64px] hover:bg-[#1B2B65] ${
                                routeActive == "/manage-question/knowledge-unit"
                                  ? "bg-[#1b2b65]"
                                  : ""
                              }`}
                            >
                  ...
                  <Disclosure>
                    {({ open }) => (
                      <>
                        <Disclosure.Button
                          className={`flex justify-between items-center w-full py-2 text-left hover:bg-[#1B2B65] ${
                            routeActive.includes("/manage-topic")
                              ? "bg-[#1b2b65]"
                              : ""
                          }`}
                        >
                        ...
                        <Link to={"/manage-tag-test"}>
                          <Disclosure.Panel
                            className={`py-4 pl-[64px] hover:bg-[#1B2B65] ${
                              routeActive.includes("/manage-tag-test")
                                ? "bg-[#1b2b65]"
                                : ""
                            }`}
                          >
              ...
              >
                ...
                >
                  <FolderOpen
                    ...
                    color="currentColor"
                    variant={
                      routeActive == "/manage-course" ? "Bold" : "Linear"
                    }
                  />
                  Quản lý khóa học
                </Link>
                  ...
                  <Disclosure>
                    {({ open }) => (
                      <>
                        <Disclosure.Button
                          className={`flex justify-between items-center w-full py-2 text-left hover:bg-[#1B2B65] ${
                            routeActive.includes("/manage-hsa")
                              ? "bg-[#1b2b65]"
                              : ""
                          }`}
                        >
